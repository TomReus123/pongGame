package actors 
{
	...
	public class Ball extends MovieClip 
	{
		...
		//variabele voor timer van hoelang de powerup werkt
		...
		{
			//eventlistener voor timer van hoelang de powerup werkt
		...
		//function voor wanneer de powerup klaar is
		...
		{
			//regel hieronder snelheid van ball aangepast
			_movement = MovementCalculator.calculateMovement(5 + Math.random() * 5, Math.random() * 360);
		...
		//function voor wanneer de powerup start
